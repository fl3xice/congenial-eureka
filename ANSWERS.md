...
#### 24. Виды графики и расширения графических файлов.
...
#### 25. Объясните понятие «BIOS». Назовите версии BIOS, возможности работы и настройки персонального компьютера при помощи BIOS.
